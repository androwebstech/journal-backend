...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2025 at 03:43 PM
...
CREATE TABLE `journals` (
  ...
  `number_of_issue_per_year` enum('Monthl','Bimonthly','Yearly','Halfyearly','Quaterly') DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `type` enum('author','publisher','reviewer') NOT NULL DEFAULT 'author',
